...
|------|-----------|-------------|
| CRM entity | `"12345"` | Resolved entities (people, companies, custom objects) |
| Ghost | `"ghost:123"` | Entities mentioned in context but not yet matched to a CRM record |
| Entity insight | `"ei:123"` | AI-extracted insight scoped to a specific entity |
| Knowledge insight | `"ki:123"` | Workspace-level AI-extracted knowledge |
